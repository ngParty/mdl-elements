...
# Contributing to mdl-elements

We'd love for you to contribute to our source code and to make mdl-elements even better than it is
...
If you have questions about how to use mdl-elements, please direct these to the [ngParty slack](https://ngparty.herokuapp.com)
mdl-elements channel or [StackOverflow][stackoverflow] or just ping us on [twitter](https://twitter.com/ngPartyCz) or so
...
* **Angular/mdl-elements/Typescript Version(s)** - is it a regression?
...
* Search [GitHub](https://github.com/ngParty/mdl-elements/pulls) for an open or closed Pull Request
...
* Run the full mdl-elements test suite, by executing `npm test` and ensure that all tests pass.
...
* In GitHub, send a pull request to `mdl-elements:master`.
* If we suggest changes then:
  * Make the required updates.
  * Re-run the mdl-elements test suite to ensure tests are still passing.
...
[coc]: https://github.com/ngParty/core/blob/master/COC.md
